...
import org.engineering.support.wheel.fate.service.impl.ConsecutiveDayRuleServiceImpl;
...
public class ConsecutiveDayRuleServiceImplTest extends BaseUnitTest{

    @InjectMocks
    RuleService ruleService = new ConsecutiveDayRuleServiceImpl();
    ...
    public void testIfEngineerIsValid() throws Exception {
        ...
        boolean actualResult = ruleService.isValid(3, 4, shifts);
